...
<div style="display:flex;align-items:center;gap:16px;margin-bottom:6px;">
  <img src="data:image/jpeg;base64,{LOGO_B64}" style="width:52px;height:52px;border-radius:8px;object-fit:cover;"/>
  <div>
    <div class="main-header">CRZ Trader — Analizador MT5</div>
    <div class="main-sub">Carga el historial .xlsx exportado desde MetaTrader 5</div>
  </div>
</div>
''', unsafe_allow_html=True)
