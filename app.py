...
if not dark_mode:
    ...
    div[data-testid="metric-container"] { background: #ffffff !important; border-color: #e2e8f0 !important; }
    div[data-testid="metric-container"] label { color: #94a3b8 !important; }
    div[data-testid="stMetricValue"] { color: #1e293b !important; }
    .alumno-bar { background: #ffffff !important; border-color: #e2e8f0 !important; }
    .alumno-name { color: #1e293b !important; }
    .section-label { color: #94a3b8 !important; }
    .stTabs [data-baseweb="tab-list"] { border-color: #e2e8f0 !important; }
    .stTabs [data-baseweb="tab"] { color: #94a3b8 !important; }
    .stTabs [aria-selected="true"] { color: #1e293b !important; border-color: #1e293b !important; }
